...
The complexity of the algorithm is the size of the universal tree.</p>

We use the notion of universal trees introduced in the [previous post]({{ '/blog/universal_trees' | prepend: site.baseurl }}).
