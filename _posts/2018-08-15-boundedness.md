...
* first apply the stabilisation operator to $\pi(\Delta(a))$
* then multiply the result with $\pi(\Delta(b))$
...
this is equivalent to asking whether $I \cdot (\pi(a) \cdot \pi(b))^\sharp \cdot F = \omega$.
...
Consider a word $w$. Thanks to Simon's factorisation theorem there exists a factorisation of $\phi(w)$ of depth $K$.
...
* If the node is a leaf this is by definition of $\pi(a)$ and $W$.
